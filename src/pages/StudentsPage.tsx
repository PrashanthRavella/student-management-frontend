...
export function StudentsPage() {
  ...
  return (
    <Stack spacing={3}>
      <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" alignItems={{ sm: 'center' }} gap={2}><Box><Typography variant="h4" component="h1" fontWeight={800}>Students</Typography><Typography color="text.secondary">Search, review, and maintain student records.</Typography></Box><Button component={Link} to="/students/new" variant="contained" startIcon={<AddIcon />}>Add student</Button></Stack>
